...
class File extends \SplFileObject
{
     ...
     * @return $this
     */
    public function isTest(bool $test = false): self
    {
        $this->isTest = $test;
        return $this;
    }
     ...
     * @return $this
     */
    public function setUploadInfo(array $info): self
    {
        $this->info = $info;
        return $this;
    }
    ...
    protected function buildSaveName($savename)
    {
        ...
        if (true === $savename) {
            if ($this->rule instanceof \Closure) {
                ...
                switch ($this->rule) {
                    case 'date':
                        $savename = date('Ymd') . DS . md5((string)microtime(true));
                        break;
                    default:
     ...
     * @return $this
     */
    private function error(int $errorNo): self
    {
        switch ($errorNo) {
            case 1:
            case 2:
